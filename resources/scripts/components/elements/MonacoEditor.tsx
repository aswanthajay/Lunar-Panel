        ...
        <div className="w-full flex flex-col bg-[#000000] border border-[#1F1F1F] rounded-md overflow-hidden" style={style}>
            ...
            <div className="bg-[#000000] border-b border-[#141414] px-4 py-2 flex items-center justify-between text-xs select-none">
                <div className="flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 text-[#71717A] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="px-2.5 py-1 rounded text-[11px] font-medium text-[#A1A1AA] hover:text-[#FAFAFA] bg-transparent hover:bg-[#18181B] border border-[#27272A] hover:border-[#3F3F46] transition-all cursor-pointer flex items-center gap-1.5 shadow-xs"
                    ...
                    <button
                        ...
                        className={`px-2.5 py-1 rounded text-[11px] font-medium transition-all cursor-pointer border flex items-center gap-1.5 shadow-xs ${
                            wordWrap === 'on'
                    ...
                    >
                        <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${wordWrap === 'on' ? 'bg-emerald-400' : 'bg-[#52525B]'}`} />
                        <span>Wrap: {wordWrap.toUpperCase()}</span>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${showMinimap ? 'bg-emerald-400' : 'bg-[#52525B]'}`} />
                        <span>Minimap: {showMinimap ? 'ON' : 'OFF'}</span>
                    </button>
                    <span className="text-[11px] font-mono text-[#71717A] select-none ml-1">Ctrl+S to save</span>
                </div>
            </div>
