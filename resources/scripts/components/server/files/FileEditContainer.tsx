                                ...
                                {isSaving ? (
                                    <>
                                        <span className="flex items-center gap-1 shrink-0">
                                            <span className="w-1 h-3 rounded-xs bg-black opacity-75 animate-pulse" />
                                            <span className="w-1 h-3 rounded-xs bg-black opacity-75 animate-pulse [animation-delay:150ms]" />
                                            <span className="w-1 h-3 rounded-xs bg-black opacity-75 animate-pulse [animation-delay:300ms]" />
                                        </span>
                                        <span>Saving...</span>
                                    </>
                                ) : isSaved ? (
