...
export default createGlobalStyle`
    ...
    /* ── Scrollbars: Completely invisible, zero visual clutter, 100% scrollable ── */
    * {
    ...
    *::-webkit-scrollbar-thumb,
    ...
    html, body, #app, .app-container, .app-body, #main-content, .app-content, .app-sidenav, .app-sidenav *, .xterm-viewport, .xterm-scroll-area, .hide-scrollbar, .no-scrollbar {
        scrollbar-width: none !important;
        -ms-overflow-style: none !important;
    }
    html::-webkit-scrollbar, body::-webkit-scrollbar, #app::-webkit-scrollbar, .app-container::-webkit-scrollbar, .app-body::-webkit-scrollbar, #main-content::-webkit-scrollbar, .app-content::-webkit-scrollbar, .app-sidenav::-webkit-scrollbar, .app-sidenav *::-webkit-scrollbar, .xterm-viewport::-webkit-scrollbar, .xterm-scroll-area::-webkit-scrollbar, .hide-scrollbar::-webkit-scrollbar, .no-scrollbar::-webkit-scrollbar {
        width: 0 !important;
        height: 0 !important;
        display: none !important;
    }
