                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Panel & Brand Name</label>
                                <div>
                                    <input type="text" class="form-control" name="app:name" value="{{ old('app:name', config('app.name', 'Lunar Panel')) }}" placeholder="Lunar Panel" />
                                    <p class="text-muted"><small>The brand name displayed in the top header (next to <code>votion /</code>), browser title bar, client emails, and navigation branding.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
